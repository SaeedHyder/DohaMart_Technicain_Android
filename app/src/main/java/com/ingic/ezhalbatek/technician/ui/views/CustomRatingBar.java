...
/**
 * Created by syeda.tafseer on 9/12/17.
 */
public class CustomRatingBar extends LinearLayout {
    ...
    private int mStarOffResource = R.drawable.star;
...
//                lastscore = mCurrentScore;
                if (getScoreForPosition(event.getX()) > mMaxStars) {
                    mCurrentScore = mMaxStars;
                }else if (getScoreForPosition(event.getX())< 0 ){
                    mCurrentScore = 0;
                }
                else
