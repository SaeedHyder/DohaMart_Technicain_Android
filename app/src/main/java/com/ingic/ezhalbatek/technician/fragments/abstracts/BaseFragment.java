package com.ingic.ezhalbatek.technician.fragments.abstracts;
...
import com.ingic.ezhalbatek.technician.helpers.GPSTracker;
import com.ingic.ezhalbatek.technician.helpers.ServiceHelper;
import com.ingic.ezhalbatek.technician.helpers.UIHelper;
import com.ingic.ezhalbatek.technician.interfaces.LoadingListener;
...
public abstract class BaseFragment extends Fragment implements webServiceResponseLisener {
    ...
    public void onResume() {
        ...
        if (!(this instanceof HomeFragment)) {
            getDockActivity().showSeprator(View.VISIBLE);
        } else {
            getDockActivity().showSeprator(View.GONE);
        }
    }
    ...
    private void Logout() {
        WebService webservice = WebServiceFactory.getWebServiceInstanceWithCustomInterceptor(getDockActivity(), WebServiceConstants.Local_SERVICE_URL);
