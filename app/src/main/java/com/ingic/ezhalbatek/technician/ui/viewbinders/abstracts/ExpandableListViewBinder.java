package com.ingic.ezhalbatek.technician.ui.viewbinders.abstracts;
...
public abstract class ExpandableListViewBinder<T,E> {
   ...
   // public abstract AdditionalTaskBinder.childViewHolder createChildViewHolder(View view);

    public abstract Object createChildViewHolder(View view);
