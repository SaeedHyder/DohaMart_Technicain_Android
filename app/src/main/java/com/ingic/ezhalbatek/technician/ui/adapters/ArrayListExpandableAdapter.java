package com.ingic.ezhalbatek.technician.ui.adapters;
...
public class ArrayListExpandableAdapter<T, E> extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        viewBinder.bindChildView(childItem, childPosition, groupPosition, convertView, mContext);
    ...
    public int getGroupTypeCount() {
        ...
        return (headerCollection != null && headerCollection.size() > 0) ? headerCollection.size() : 1;
    }
