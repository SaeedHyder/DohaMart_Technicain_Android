...
public class RequestNewJobsBinder extends RecyclerViewBinder<UserPaymentEnt> implements View.OnClickListener {
    private RecyclerItemListener listener;

    public RequestNewJobsBinder(RecyclerItemListener listener) {
